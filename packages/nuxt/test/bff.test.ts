...
vi.mock('h3', () => ({
  ...
  useSession: async (event: { __session: unknown }) => event.__session,
}))
...
function makeEvent(o: { path: string, method?: string, body?: string, headers?: Record<string, string>, session: ReturnType<typeof makeSession> }) {
  return { path: o.path, method: o.method ?? 'GET', body: o.body, headers: o.headers ?? {}, __session: o.session, status: 200 }
}
